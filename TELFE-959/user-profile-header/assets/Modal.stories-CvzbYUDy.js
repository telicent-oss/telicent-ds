...
25/03/2024
`,po={title:"Utils/Modal",component:p,tags:["autodocs"],argTypes:{onClose:{description:"Callback fired when the modal is closed.",type:"function"},children:{control:!1,description:"Content inside the component",table:{type:{summary:"ReactNode"}}}}},r={render:t=>{const[n,a]=y.useState(!0);return s(d,{children:[e(f,{variant:"contained",onClick:()=>a(!0),children:"Open Modal"}),e(p,{...t,open:n,onClose:(M,i)=>{if(i==="closeButtonClick"||i==="backdropClick"||i==="escapeKeyDown")a(!1);else throw new Error(`Unknown reason: ${i}`)},children:s(d,{children:[e(w,{id:"modal-title",children:"Data handling policy:"}),e(k,{id:"modal-title",children:"Data set 1:"}),e(g,{}),e(c,{sx:{mt:1,overflow:"auto",flex:"1 1 auto"},children:e(x,{whiteSpace:"preserve",children:T})})]})})]})}};var u,m,h;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: args => {
...
}`,...(h=(m=r.parameters)==null?void 0:m.docs)==null?void 0:h.source}}};const uo=["Example"];export{r as Example,uo as __namedExportsOrder,po as default};
