import{a as j,j as t}from"./emotion-react-jsx-runtime.browser.esm-CUMkBk-e.js";import{T as k}from"./TeliChip-2hG-pJcP.js";/* empty css                  *//* empty css                      */import{I as V,S as C,F as o,a as N}from"./Select-DvxZuTWq.js";import{M as O}from"./MenuItem-_24OEzRD.js";import{B as P}from"./Box-BAFJFhUk.js";const E=({id:l,selectId:u,label:a,options:d=[],value:p,defaultOpen:c,defaultValue:m,helperText:s,disabled:f=!1,error:h=!1,focused:y,fullWidth:v=!1,hiddenLabel:n=!1,multiple:b=!1,open:g,readOnly:T=!1,required:r=!1,width:w,onChange:q,onClose:I,onOpen:x})=>{const S=()=>n?{displayEmpty:!0}:{labelId:l,label:a,displayEmpty:!1},R=()=>b?{multiple:!0,renderValue:e=>t(P,{sx:{display:"flex",flexWrap:"wrap",gap:.5},children:e.map(i=>t(k,{label:i,variant:"tertiary"},i))})}:{};return j(N,{className:"teli-select",sx:{minWidth:88,width:w},size:"small",disabled:f,error:h,required:r,fullWidth:v,focused:y,hiddenLabel:n,children:[!n&&t(V,{id:l,children:a}),t(C,{...S(),...R(),id:u,value:p,onChange:q,size:"small",defaultOpen:c,defaultValue:m,open:g,onOpen:x,onClose:I,inputProps:{"aria-label":n?a:void 0,readOnly:T},MenuProps:{className:"teli-basic-menu",sx:{marginTop:"6px"}},children:d.map(e=>t(O,{value:(e==null?void 0:e.value)||e.label,children:e.label},(e==null?void 0:e.id)||e.label))}),s?t(o,{children:s}):r?t(o,{children:"Required *"}):null]})};E.__docgenInfo={description:"",methods:[],displayName:"TeliSelect",props:{defaultOpen:{required:!1,tsType:{name:"boolean"},description:`If true, the component is initially open. Use when the component open state
...
option in order to be selected.`}}};export{E as T};
