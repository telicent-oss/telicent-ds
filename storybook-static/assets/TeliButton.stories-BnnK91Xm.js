import{T as e}from"./TeliButton-DBBf574w.js";import{j as t}from"./jsx-runtime-CexXSJP5.js";import{F as i,c as n,u as p}from"./index-EaYoR7Ht.js";import"./index-BP8_t0zE.js";import"./index-CSpfAsmC.js";import"./ButtonBase-DxHKNkXA.js";import"./extends-BFqQA52f.js";import"./createTheme-BI2OWDpv.js";import"./styled-CwhWP0k9.js";import"./DefaultPropsProvider-D6MvNwoC.js";import"./StyledEngineProvider-CtQ9vdjp.js";import"./generateUtilityClasses-CPjhs1S_.js";import"./TransitionGroupContext-Cc1z3uP3.js";import"./assertThisInitialized-B9jnkVVz.js";import"./inheritsLoose-DR8r8Ogv.js";import"./useForkRef-rM2yqL0Y.js";import"./index-BjJ5k6rE.js";import"./Popper-Cg5SJw39.js";import"./ownerDocument-DW-IO8s5.js";import"./Grow-Dt6YTbxq.js";import"./index-BVEwUaSm.js";import"./useTheme-CmkBszCQ.js";import"./useTheme-BOvJgVym.js";import"./useThemeWithoutDefault-C3kYH7vc.js";import"./utils-IhZQnaQC.js";import"./useSlotProps-DmXLjd2q.js";import"./resolveComponentProps-iAOpfAUw.js";import"./isHostComponent-DVu5iVWx.js";import"./useControlled-im5M3O13.js";import"./useId-DLncWxdO.js";import"./index-CXPIPAcP.js";const m={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"primary",startIcon:t.jsx(i,{icon:n}),children:"Delete"}),t.jsx(e,{variant:"secondary",endIcon:t.jsx(i,{icon:p}),children:"Send"})]}),parameters:{docs:{description:{story:`
...
<TeliButton aria-label="send" variant="basic">
  <FontAwesomeIcon icon={faSend} />
      ...
      `}}}},tt=h,T={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"primary",color:"danger",children:"Danger Primary"}),t.jsx(e,{variant:"primary",color:"danger",disabled:!0,children:"Danger Primary"})]}),parameters:{docs:{description:{story:`
...
<TeliButton variant="link" href="#link" disabled>
  Disabled with href
      ...
      `}}}},ot=y,B={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"tertiary",children:"Tertiary"}),t.jsx(e,{variant:"tertiary",disabled:!0,children:"Disabled Tertiary"})]}),parameters:{docs:{description:{story:`
...
<TeliButton variant="tertiary" disabled>
  Disabled Tertiary
      ...
      `}}}},it=B,g={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"secondary",children:"Secondary"}),t.jsx(e,{variant:"secondary",disabled:!0,children:"Disabled secondary"})]}),parameters:{docs:{description:{story:`
...
<TeliButton variant="secondary" disabled>
  Disabled secondary
      ...
      `}}}},nt=g,v={render:()=>t.jsxs("div",{className:"grid grid-rows-1 grid-cols-4 gap-4",children:[t.jsx(e,{variant:"primary",children:"Primary"}),t.jsx(e,{variant:"primary",disabled:!0,children:"Disabled Primary"})]}),parameters:{docs:{description:{story:`
...
>
  Bottom end
      ...
      `}}}},at=x,st={component:e,parameters:{docs:{source:{type:"dynamic"}}}},r={args:{children:"Default button",onClick:()=>alert("Clicked default button")}};var a,s,l,c,d;r.parameters={...r.parameters,docs:{...(a=r.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
...
refer to the MUI and MDN documentation for a full list of props`,...(d=(c=r.parameters)==null?void 0:c.docs)==null?void 0:d.description}}};const lt=["Basic","PrimaryButtons","SecondaryButtons","TertiaryButtons","LinkButtons","DangerButtons","ButtonsWithIcons","IconButtons","Sizes","ButtonsWithTooltips"];export{r as Basic,Y as ButtonsWithIcons,at as ButtonsWithTooltips,et as DangerButtons,tt as IconButtons,ot as LinkButtons,rt as PrimaryButtons,nt as SecondaryButtons,Z as Sizes,it as TertiaryButtons,lt as __namedExportsOrder,st as default};
