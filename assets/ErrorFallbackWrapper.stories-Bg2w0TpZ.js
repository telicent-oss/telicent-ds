import{j as e}from"./emotion-react-jsx-runtime.browser.esm-e0zr1XFC.js";import{E as i}from"./ErrorFallbackWrapper-76NLnkLs.js";import{E as p}from"./ErrorFallbackText-BExZ28uU.js";import{k as R}from"./defaultTheme-Cd36Xqui.js";import{T as I}from"./ThemeProvider-CVHsKeZ1.js";import{B as j}from"./Box-C8UM6PF1.js";import"./jsx-runtime-CB_V9I5Y.js";import"./index-CTjT7uj6.js";import"./Typography-BTuSrW-Q.js";import"./styled-Co95aX7f.js";import"./generateUtilityClasses-LAuhwvbW.js";import"./DefaultPropsProvider-BJrUAfpV.js";import"./useTheme-N1zbQagn.js";import"./index-gbGX4Sgq.js";import"./useId-DMVUMfb1.js";import"./useEnhancedEffect-TT6gT8pk.js";import"./GlobalStyles-Cv-yeoYN.js";const ar={title:"Utils/ErrorFallback/ErrorFallbackWrapper",component:i,tags:["autodocs"],args:{},decorators:[r=>e(j,{sx:{bgcolor:"background.paper",p:2,border:1,borderColor:"grey.300",borderRadius:1},children:r()})]},a={args:{children:e(p,{})},render:r=>e(i,{...r})},o={args:{children:e(p,{message:"Unable to fetch user profile."})},render:r=>e(i,{...r}),parameters:{docs:{description:{story:"Pass `message` to ErrorFallbackText to override the default interpolation. Here it displays: “Unable to fetch user profile.”"}}}},t={args:{height:150,children:e(p,{name:"DashboardWidget"})},render:r=>e(i,{...r}),parameters:{docs:{description:{story:"Set `height` on ErrorFallbackWrapper to alter vertical centering. This example uses a 150px tall container."}}}},s={args:{height:200,sx:r=>({width:"100%",backgroundColor:r.palette.background.paper,border:1,borderColor:r.palette.error.main,borderRadius:2,p:1}),children:e(p,{name:"Chart"})},render:r=>{const M=R({palette:{background:{paper:"thistle"},error:{main:"#f44336"},grey:{100:"#f5f5f5"}}});return e(I,{theme:M,children:e(i,{...r})})},parameters:{docs:{description:{story:"- with custom theme"}}}},n={args:{children:null},render:()=>e(p,{message:"Inline load failure."}),parameters:{docs:{description:{story:"Use ErrorFallbackText alone when centering is handled externally (e.g., within a grid cell). Pass `message` or `name` as needed."}}}};var l,c,d,m,h;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
