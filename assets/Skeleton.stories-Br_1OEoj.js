import{m as x,b as i,k as p,u as $,_ as U,j}from"./DefaultPropsProvider-FmOZEx_L.js";import{r as A}from"./index-BBkUAzwr.js";import{g as M,s as B,c as X,a as E}from"./styled-CKqgJSB4.js";import{g as F}from"./generateUtilityClasses-DiIBTi47.js";import{j as N}from"./jsx-runtime-DRTy3Uxn.js";import{a as K}from"./colorManipulator-uiArQTW6.js";function O(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function P(t){return parseFloat(t)}function W(t){return M("MuiSkeleton",t)}F("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const D=["animation","className","component","height","style","variant","width"];let l=t=>t,m,g,f,b;const L=t=>{const{classes:e,variant:a,animation:s,hasChildren:o,width:d,height:n}=t;return E({root:["root",a,s,o&&"withChildren",o&&!d&&"fitContent",o&&!n&&"heightAuto"]},W,e)},T=x(m||(m=l`
  0% {
    opacity: 1;
  }
