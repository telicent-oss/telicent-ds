...
import { CardContentOwnProps } from '@mui/material';
import { CardHeaderClasses } from '@mui/material';
import { CardHeaderProps } from '@mui/material/CardHeader';
import { CardHeaderProps as CardHeaderProps_2 } from '@mui/material';
...
import { DrawerProps as DrawerProps_3 } from '@mui/material';
...
import { ImageListItemBarProps } from '@mui/material';
...
import { InputBaseProps as InputBaseProps_2 } from '@mui/material';
...
import { LinearProgressProps as LinearProgressProps_2 } from '@mui/material';
...
import { ListItemIconProps as ListItemIconProps_2 } from '@mui/material';
...
import { ListItemTextProps as ListItemTextProps_3 } from '@mui/material';
...
import { ModalProps as ModalProps_3 } from '@mui/material';
...
import { SpeedDialIconProps } from '@mui/material';
...
import { ToggleButtonProps as ToggleButtonProps_2 } from '@mui/material';
...
export declare const Container: default_2.FC<ContainerProps_2>;

declare interface ContainerProps_2 extends default_2.HTMLAttributes<HTMLDivElement>, PropsWithChildren {
...
export declare type DirectionMarker = {
    type: "triangle";
} | {
    type: "svg";
    markup: string;
...
export declare interface DirectionStyle {
    color?: string;
    size?: number;
...
declare const generateComponentOverrides: (uiTheme: UITheme) => {
    ...
    MuiCard: {
        ...
        styleOverrides: {
            root: ({ theme }: CardOwnProps & CommonProps & Omit<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "className" | "style" | "classes" | "children" | "sx" | "variant" | "square" | "elevation" | "raised"> & {
                component?: ElementType;
            } & Record<string, unknown> & {
                ownerState: CardOwnProps & CommonProps & Omit<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "className" | "style" | "classes" | "children" | "sx" | "variant" | "square" | "elevation" | "raised"> & {
                    component?: ElementType;
                } & Record<string, unknown>;
            } & {
                theme: Omit<Theme_2, "components">;
    ...
    MuiCardContent: {
        styleOverrides: {
            root: ({ theme }: CardContentOwnProps & CommonProps & Omit<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "className" | "style" | "classes" | "children" | "sx"> & {
                component?: ElementType;
            } & Record<string, unknown> & {
                ownerState: CardContentOwnProps & CommonProps & Omit<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "className" | "style" | "classes" | "children" | "sx"> & {
                    component?: ElementType;
                } & Record<string, unknown>;
            } & {
                theme: Omit<Theme_2, "components">;
...
export declare const ListItemText: default_2.FC<ListItemTextProps_2>;

declare interface ListItemTextProps_2 extends Omit<ListItemTextProps, "primaryTypographyProps" | "secondaryTypographyProps" | "sx"> {
}
...
export declare interface PathStyle {
    color: string;
    width?: number;
    lineDash?: number[];
