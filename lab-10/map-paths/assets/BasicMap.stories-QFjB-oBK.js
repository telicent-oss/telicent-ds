import{r as d,a as i,j as e}from"./iframe-wwyKJVT7.js";import{x as g,y as qe,z as Ke,F as Ye}from"./DropdownButton-BjR4G6c6.js";import{E as Qe}from"./ErrorFallback-SJMDDmk_.js";import{E as D}from"./ErrorFallbackText-CQHNy6L3.js";import{E as Xe}from"./ErrorFallbackWrapper-C_Ne2lSR.js";import{B as c}from"./Box-CvHLitPM.js";import{S as h}from"./Stack-DkIolbKj.js";import{B as m}from"./Button-BUB-REPY.js";import"./preload-helper-C1FmrZbK.js";import"./UserIcon-BJUhZHXy.js";import"./SvgIcon-CUVs1lE1.js";import"./generateUtilityClass-CkoJfXzB.js";import"./styled-LpRxHRpP.js";import"./generateUtilityClasses-lZioDJSU.js";import"./useTheme-fWgDsTlF.js";import"./Box-BfkY0LoG.js";import"./Container-Ex8awo5l.js";import"./styled-CqLf-K_6.js";import"./createStyled-7rACZg1S.js";import"./useThemeProps-DGz7F6m3.js";import"./FlexBox-PSVLjaHH.js";import"./Typography-KsMZ-Lzq.js";import"./Paper-Ty8OBP7-.js";import"./useThemeProps-6ff9_uQw.js";import"./Text-Cs_t5jTe.js";import"./AdapterDayjs-DLuz1KZP.js";import"./Modal-FJt4lU_X.js";import"./utils-De2QkNKz.js";import"./TransitionGroupContext-Ci1yj1nx.js";import"./index-Bc6yxq3M.js";import"./resolveComponentProps-Tez3FZ9N.js";import"./Popover-ad1rGmx0.js";import"./TextField-DQEmSFXz.js";import"./useFormControl-Bu5lKDwq.js";import"./createSvgIcon-Bca1zsRN.js";import"./IconButton-DAUWwzIO.js";import"./ButtonBase-ZfxRSw2y.js";import"./DialogContent-B9FHsown.js";import"./Chip-dWFWXs2g.js";import"./DateTimePicker-CCwiql_t.js";import"./Divider-CgD_nbzY.js";import"./AppInfoRow-DD0pDyG_.js";import"./Chip-BBcf24H1.js";import"./Divider-DvGORPwC.js";import"./TreeView-BUpBgZFV.js";import"./Alert-BSE5AHq1.js";import"./LinearProgress-rfUNUhKS.js";import"./Spinner-tbj581ml.js";import"./Dialog-BtzheIZz.js";import"./MapToggleButtonPresentational-DIhML7LJ.js";import"./Remove-BOsHTnyW.js";import"./LinkButton-tlP8KO0e.js";import"./TextField-DzD39lVx.js";import"./Switch-DnCT64eH.js";import"./DatePicker-C6MhubZW.js";import"./Paper-K6NL7s7r.js";import"./Brand-Bn9laiH-.js";import"./Edit-CBu4FngS.js";const p=[{id:"OpenStreetMap",kind:"base-raster",provider:"xyz",label:"OpenStreetMap",url:"https://tile.openstreetmap.org/{z}/{x}/{y}.png",previewImage:"/images/street.png",visible:!0}],f={zoom:5,center:[0,0],layers:p,mapStyleOptions:void 0,markers:[],polygons:[],paths:[]},bt={title:"Component Library/Map/composites/BasicMapV2",component:g,tags:["map","basic","autodocs"],parameters:{docs:{description:{component:`
### Overview
...
This text documents the intended behaviour, the real limitations to watch for, and actionable workarounds so consumers of the component know exactly what to expect.
  ...
  polygons: [],
  paths: []
}`,...(W=(H=f.parameters)==null?void 0:H.docs)==null?void 0:W.source}}};var j,V,_;S.parameters={...S.parameters,docs:{...(j=S.parameters)==null?void 0:j.docs,source:{originalSource:"{}",...(_=(V=S.parameters)==null?void 0:V.docs)==null?void 0:_.source}}};var N,q,K;w.parameters={...w.parameters,docs:{...(N=w.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    layers: baseLayers
  }
...
}`,...(ee=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:ee.source},description:{story:"Markers, polygons and paths all report through `onFeatureClick` and\n`onFeatureHover`. Only a marker click moves the view.",...(te=(re=y.parameters)==null?void 0:re.docs)==null?void 0:te.description}}};var oe,ne,ae;x.parameters={...x.parameters,docs:{...(oe=x.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    layers: baseLayers,
    paths: samplePaths
  }
...
}`,...(le=(ie=F.parameters)==null?void 0:ie.docs)==null?void 0:le.source}}};var ce,pe,de;L.parameters={...L.parameters,docs:{...(ce=L.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    zoom: 6,
    center: [-1.5, 53.5],
    layers: baseLayers,
...
}`,...(de=(pe=L.parameters)==null?void 0:pe.docs)==null?void 0:de.source}}};var me,he,ge;P.parameters={...P.parameters,docs:{...(me=P.parameters)==null?void 0:me.docs,source:{originalSource:`{
  args: {
    zoom: 5,
    center: [2, 52],
    layers: baseLayers,
...
}`,...(xe=(we=B.parameters)==null?void 0:we.docs)==null?void 0:xe.source}}};var Fe,Le,Pe;T.parameters={...T.parameters,docs:{...(Fe=T.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  render: () => <RuntimeOpacityDemo />
}`,...(Pe=(Le=T.parameters)==null?void 0:Le.docs)==null?void 0:Pe.source}}};var ze,Me,Be;E.parameters={...E.parameters,docs:{...(ze=E.parameters)==null?void 0:ze.docs,source:{originalSource:`{
...
}`,...($e=(Ee=v.parameters)==null?void 0:Ee.docs)==null?void 0:$e.source},description:{story:"Toggling `pathStyle` on against two paths that carry their own `style`.\nWith it supplied every path draws grey or orange; without it, the per-path\npink and blue. See `pathStyle` in map-types.ts.",...(Re=(Ce=v.parameters)==null?void 0:Ce.docs)==null?void 0:Re.description}}};var Ae,De,Oe,Ie,He;k.parameters={...k.parameters,docs:{...(Ae=k.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  render: () => <MalformedFeatureReportedDemo />
}`,...(Oe=(De=k.parameters)==null?void 0:De.docs)==null?void 0:Oe.source},description:{story:"`bad-path` declares `LineString` but carries `number[]`, so it is skipped and\nreported once through `onError`; `good-path` still draws. The panel lists\neach `onError` call.",...(He=(Ie=k.parameters)==null?void 0:Ie.docs)==null?void 0:He.description}}};var We,je,Ve,_e,Ne;b.parameters={...b.parameters,docs:{...(We=b.parameters)==null?void 0:We.docs,source:{originalSource:`{
  render: () => <LayerSetupFailureDemo />
}`,...(Ve=(je=b.parameters)==null?void 0:je.docs)==null?void 0:Ve.source},description:{story:"An unrecognised layer kind makes layer setup fail. `onError` is called and no\nlayers are set, so the map stays blank on first load.",...(Ne=(_e=b.parameters)==null?void 0:_e.docs)==null?void 0:Ne.description}}};const ft=["allArgs","Empty","Template","FeatureEvents","MarkerPolygonAndPathInteraction","WithPaths","WithMarkersAndPaths","MovementTrail","DirectionTriangle","DirectionSvg","MovementTrailWithDirection","ConfigDrivenOpacity","RuntimeOpacity","PathStyleFunction","PathStyleBeatsPerPathStyle","MalformedFeatureReportedToOnError","LayerSetupFailureReportsToOnError"];export{B as ConfigDrivenOpacity,z as DirectionSvg,P as DirectionTriangle,S as Empty,u as FeatureEvents,b as LayerSetupFailureReportsToOnError,k as MalformedFeatureReportedToOnError,y as MarkerPolygonAndPathInteraction,L as MovementTrail,M as MovementTrailWithDirection,v as PathStyleBeatsPerPathStyle,E as PathStyleFunction,T as RuntimeOpacity,w as Template,F as WithMarkersAndPaths,x as WithPaths,ft as __namedExportsOrder,f as allArgs,bt as default};
