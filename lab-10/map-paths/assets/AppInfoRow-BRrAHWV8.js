import{r as p,j as t,a as c,F as m}from"./iframe-pszacA4H.js";import{I as f}from"./IconButton-5N96Sbkv.js";import{B as u}from"./Box-rB9UFT7p.js";import{u as g}from"./useTheme-Bw0ZNVbz.js";import{P as v}from"./Popover-CLeTkZpW.js";import{I as T,F as w}from"./FlexBox-P753RbX0.js";import{T as s}from"./Text-CY99CXXY.js";const l=p.forwardRef((e,o)=>t(f,{ref:o,...e}));l.__docgenInfo={description:"",methods:[],displayName:"IconButton"};const d=e=>{const o=g();return t(v,{elevation:3,slotProps:{paper:{sx:{backgroundColor:o.palette.mode==="dark"?"#2A2A2A":"#eee",backgroundImage:"none",width:e.width,padding:2}}},...e})};d.__docgenInfo={description:`A PopOver can be used to display some content on top of another.
