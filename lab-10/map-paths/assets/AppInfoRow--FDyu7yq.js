import{r as p,j as t,a as c,F as m}from"./iframe-BWbl0n-m.js";import{I as f}from"./IconButton-DGKGWhyR.js";import{B as u}from"./Box-BWzji7VQ.js";import{u as g}from"./useTheme-DmjRKZlb.js";import{P as v}from"./Popover-BrYdNkwn.js";import{I as T,F as w}from"./FlexBox-D_1rxin-.js";import{T as s}from"./Text-BpKGjeEj.js";const l=p.forwardRef((e,o)=>t(f,{ref:o,...e}));l.__docgenInfo={description:"",methods:[],displayName:"IconButton"};const d=e=>{const o=g();return t(v,{elevation:3,slotProps:{paper:{sx:{backgroundColor:o.palette.mode==="dark"?"#2A2A2A":"#eee",backgroundImage:"none",width:e.width,padding:2}}},...e})};d.__docgenInfo={description:`A PopOver can be used to display some content on top of another.
