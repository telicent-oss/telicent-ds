import{r as p,j as t,a as c,F as m}from"./iframe-BF8_hFNx.js";import{I as f}from"./IconButton-Gc7uHhHy.js";import{B as u}from"./Box-CUYKe1tY.js";import{u as g}from"./useTheme-DZci25c3.js";import{P as v}from"./Popover-9qKCk_MS.js";import{I as T,F as w}from"./FlexBox-DrOT4QhN.js";import{T as s}from"./Text-DU9ZnK76.js";const l=p.forwardRef((e,o)=>t(f,{ref:o,...e}));l.__docgenInfo={description:"",methods:[],displayName:"IconButton"};const d=e=>{const o=g();return t(v,{elevation:3,slotProps:{paper:{sx:{backgroundColor:o.palette.mode==="dark"?"#2A2A2A":"#eee",backgroundImage:"none",width:e.width,padding:2}}},...e})};d.__docgenInfo={description:`A PopOver can be used to display some content on top of another.
