import{r as $,q as U,c as A,_ as i,b as M,M as j,H as p,K as x,j as B}from"./iframe-CYeXSRCn.js";import{g as X,c as E}from"./generateUtilityClass-CRJ1fUnr.js";import{c as F,s as K}from"./styled-Ch7TYyIp.js";import{g as N}from"./generateUtilityClasses-8aJfFmyf.js";import"./preload-helper-C1FmrZbK.js";function O(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function P(t){return parseFloat(t)}function W(t){return X("MuiSkeleton",t)}N("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const q=["animation","className","component","height","style","variant","width"];let l=t=>t,m,g,f,b;const D=t=>{const{classes:e,variant:a,animation:s,hasChildren:n,width:d,height:o}=t;return F({root:["root",a,s,n&&"withChildren",n&&!d&&"fitContent",n&&!o&&"heightAuto"]},W,e)},H=x(m||(m=l`
  0% {
    opacity: 1;
  }
