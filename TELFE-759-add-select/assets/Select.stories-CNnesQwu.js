...
/>
\`\`\`
`}},id:"select-default",ariaLabel:"select-dropdown",options:t},decorators:e=>i(N,{sx:{margin:"auto"},children:e()})},T=({...e})=>{const[v,x]=I.useState("");return i(O,{label:"Select Option",value:v,onChange:W=>{x(W.target.value)},options:t,id:"selected-demo",...e})},n={args:{label:"Select an option",value:"none",id:"select-disabled",options:t,width:300,onChange:()=>{}}},r={args:{label:"Select an option",value:"none",id:"select-disabled",options:t,width:300,onChange:()=>{},disabled:!0}},a={args:{label:"Select an option",value:"none",id:"select-disabled",options:t,width:500,onChange:()=>{}}},o={render:e=>i(T,{...e}),args:{width:250,disabled:!1}};var s,p,l;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    label: "Select an option",
    value: "none",
    id: "select-disabled",
...
}`,...(l=(p=n.parameters)==null?void 0:p.docs)==null?void 0:l.source}}};var d,m,c;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    label: "Select an option",
    value: "none",
    id: "select-disabled",
...
}`,...(c=(m=r.parameters)==null?void 0:m.docs)==null?void 0:c.source}}};var u,h,g;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    label: "Select an option",
    value: "none",
    id: "select-disabled",
...
}`,...(g=(h=a.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var b,S,w,f,C;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
