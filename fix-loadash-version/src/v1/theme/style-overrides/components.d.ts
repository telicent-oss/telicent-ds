...
declare const generateComponentOverrides: (uiTheme: UITheme) => {
    ...
    MuiAutocomplete: {
        styleOverrides: {
            ...
            listbox: ({ theme }: import('@mui/material').AutocompleteProps<any, any, any, any, "div"> & Record<string, unknown> & {
                ownerState: import('@mui/material').AutocompleteProps<any, any, any, any, "div"> & Record<string, unknown>;
            } & {
                theme: Omit<import('@mui/material').Theme, "components">;
            }) => {
            ...
            option: ({ theme }: import('@mui/material').AutocompleteProps<any, any, any, any, "div"> & Record<string, unknown> & {
                ownerState: import('@mui/material').AutocompleteProps<any, any, any, any, "div"> & Record<string, unknown>;
            } & {
                theme: Omit<import('@mui/material').Theme, "components">;
            }) => {
    ...
    MuiCssBaseline: {
        styleOverrides: (theme: Omit<import('@mui/material').Theme, "components">) => string;
    };
    MuiCard: {
        variants: {
            props: {
