import{r as $,x as U,_ as A,b as i,y as j,S as M,L as p,P as y,j as B}from"./iframe-CEWiRzw6.js";import{g as X,c as E,a as F,s as N}from"./styled-BMacbev-.js";import{g as P}from"./generateUtilityClasses-Cw_0ODav.js";import"./preload-helper-C1FmrZbK.js";function K(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function L(t){return parseFloat(t)}function O(t){return X("MuiSkeleton",t)}P("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const W=["animation","className","component","height","style","variant","width"];let l=t=>t,m,g,f,b;const D=t=>{const{classes:e,variant:a,animation:s,hasChildren:n,width:d,height:o}=t;return F({root:["root",a,s,n&&"withChildren",n&&!d&&"fitContent",n&&!o&&"heightAuto"]},O,e)},T=y(m||(m=l`
  0% {
    opacity: 1;
  }
