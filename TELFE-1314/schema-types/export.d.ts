...
export declare type AuthV2Config = z.infer<typeof AuthV2ConfigSchema>;
 ...
 * ```
 */
export declare const AuthV2ConfigSchema: z.ZodObject<{
    authServerUrl: z.ZodString;
    popupRedirectUri: z.ZodString;
}, "strip", z.ZodTypeAny, {
