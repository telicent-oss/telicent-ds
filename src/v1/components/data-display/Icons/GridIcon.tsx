...
const GridIcon: React.FC<MUISvgIconProps> = (iconProps) => (
  <MUISvgIcon {...iconProps}>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" fill="none">
      <path
        d="M25.6673 7.33337H18.334V14.6667H25.6673V7.33337Z"
        fill="currentColor"
      />
      <path
        d="M14.6673 18.3334H7.33398V25.6667H14.6673V18.3334Z"
        fill="currentColor"
      />
      <path
        d="M25.6673 18.3334H18.334V25.6667H25.6673V18.3334Z"
        fill="currentColor"
      />
      <path
        d="M36.6673 18.3334H29.334V25.6667H36.6673V18.3334Z"
        fill="currentColor"
      />
      <path
        d="M18.334 29.3334H25.6673V36.6667H18.334V29.3334Z"
        fill="currentColor"
      />
      <path
