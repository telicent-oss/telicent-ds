...
export const DropDownChangingButtonIcon: Story = {
  render: () => {
    const [selectedId, setSelectedId] = React.useState<"grid" | "list" | "table">("grid");
    ...
    const options = [
      ...
      onClick: () => setSelectedId(opt.id as typeof selectedId),
    }));
