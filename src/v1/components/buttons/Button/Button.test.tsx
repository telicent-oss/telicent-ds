...
describe("Button", () => {
  ...
  beforeAll(() => {
    const { container } = render(<Button children="Test Button" />);
    baseEl = container.firstChild as HTMLElement;
  });
  ...
  it("base default snapshot", () => {
    expect(baseEl).toMatchInlineSnapshot(`
      .emotion-0 {
