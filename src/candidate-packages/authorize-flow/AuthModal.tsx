...
import { FlexBox, UITheme, Button, Modal } from "../../export";
import { Box } from "@mui/material";
import UIThemeProvider from "../../v1/theme/UIThemeProvider";
...
export const AuthModal: React.FC<AuthRedirectModalProps> = ({
	...
	const handleAuthMessage = useCallback((message: MessageEvent) => {
		console.log({ message, triggered: alreadyTriggered.current, channelName })
