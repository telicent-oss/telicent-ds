...
const renderComponent = (props?: Partial<MiniSearchAutocompleteProps>) => {
  return setup(<MiniSearchAutocomplete options={options} placeholder="Search for a fruit" {...props} />);
};
...
describe("MiniSearchAutocomplete", () => {
  ...
  test("calls renderOption if provided", async () => {
    const customRenderOption = jest.fn((props, option) => <li {...props}>{option.label} (custom)</li>);
