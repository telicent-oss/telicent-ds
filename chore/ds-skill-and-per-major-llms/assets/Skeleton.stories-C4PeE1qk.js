import{j as $}from"./emotion-react-jsx-runtime.browser.esm-OTCsP_zj.js";import{a as U,_ as i,t as p,w as x}from"./defaultTheme-ACnAOKMv.js";import{r as j}from"./index-7LYIoTbn.js";import{g as A,c as M,a as B,s as X}from"./styled-Dr6LHSty.js";import{g as E}from"./generateUtilityClasses-CBlNI-gU.js";import{j as F}from"./jsx-runtime-BjG_zV1W.js";import{u as N}from"./DefaultPropsProvider-BINl2W1D.js";import{a as K}from"./colorManipulator-4CHxWgpo.js";function O(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function P(t){return parseFloat(t)}function W(t){return A("MuiSkeleton",t)}E("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const D=["animation","className","component","height","style","variant","width"];let l=t=>t,m,g,f,b;const L=t=>{const{classes:e,variant:a,animation:o,hasChildren:r,width:d,height:s}=t;return B({root:["root",a,o,r&&"withChildren",r&&!d&&"fitContent",r&&!s&&"heightAuto"]},W,e)},T=x(m||(m=l`
  0% {
    opacity: 1;
  }
...
`)),q=X("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(t,e)=>{const{ownerState:a}=t;return[e.root,e[a.variant],a.animation!==!1&&e[a.animation],a.hasChildren&&e.withChildren,a.hasChildren&&!a.width&&e.fitContent,a.hasChildren&&!a.height&&e.heightAuto]}})(({theme:t,ownerState:e})=>{const a=O(t.shape.borderRadius)||"px",o=P(t.shape.borderRadius);return i({display:"block",backgroundColor:t.vars?t.vars.palette.Skeleton.bg:K(t.palette.text.primary,t.palette.mode==="light"?.11:.13),height:"1.2em"},e.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${o}${a}/${Math.round(o/.6*10)/10}${a}`,"&:empty:before":{content:'"\\00a0"'}},e.variant==="circular"&&{borderRadius:"50%"},e.variant==="rounded"&&{borderRadius:(t.vars||t).shape.borderRadius},e.hasChildren&&{"& > *":{visibility:"hidden"}},e.hasChildren&&!e.width&&{maxWidth:"fit-content"},e.hasChildren&&!e.height&&{height:"auto"})},({ownerState:t})=>t.animation==="pulse"&&p(f||(f=l`
    ...
    `),V,(e.vars||e).palette.action.hover)),z=j.forwardRef(function(e,a){const o=N({props:e,name:"MuiSkeleton"}),{animation:r="pulse",className:d,component:s="span",height:c,style:w,variant:_="text",width:R}=o,h=U(o,D),u=i({},o,{animation:r,component:s,variant:_,hasChildren:!!h.children}),S=L(u);return F.jsx(q,i({as:s,ref:a,className:M(S.root,d),ownerState:u},h,{style:i({width:R,height:c},w)}))}),y=z,et={title:"Feedback/Skeleton",component:y},n={args:{},parameters:{docs:{description:{story:'A component used to visually stub out text/images which are "pending".'}}},render:t=>$(y,{...t})};var v,k,C;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {},
  parameters: {
    docs: {
      description: {
