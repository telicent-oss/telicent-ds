import{r as $,t as U,c as A,_ as i,b as j,N as M,I as p,L as x,j as B}from"./iframe-CA_6RkqO.js";import{g as N,c as X}from"./generateUtilityClass-CfDRvlGw.js";import{c as E,s as F}from"./styled-CVefpKE-.js";import{g as K}from"./generateUtilityClasses-C47siXwS.js";import"./preload-helper-C1FmrZbK.js";function L(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function O(t){return parseFloat(t)}function P(t){return N("MuiSkeleton",t)}K("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const W=["animation","className","component","height","style","variant","width"];let l=t=>t,m,g,f,b;const D=t=>{const{classes:e,variant:a,animation:s,hasChildren:n,width:d,height:o}=t;return E({root:["root",a,s,n&&"withChildren",n&&!d&&"fitContent",n&&!o&&"heightAuto"]},P,e)},I=x(m||(m=l`
  0% {
    opacity: 1;
  }
