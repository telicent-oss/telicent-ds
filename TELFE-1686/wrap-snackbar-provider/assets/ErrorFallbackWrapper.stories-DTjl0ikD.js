import{j as e,k as R,l as I}from"./iframe-BXY8qhtT.js";import{E as l}from"./ErrorFallbackWrapper-F_6HkMfr.js";import{E as i}from"./ErrorFallbackText-BbxsiRdP.js";import{B as j}from"./Box-DmdH8_CM.js";import"./preload-helper-C1FmrZbK.js";import"./Typography-D_A1aX7c.js";import"./generateUtilityClass-wYVai49J.js";import"./styled-H7Fdw8PF.js";import"./generateUtilityClasses-BA7K2SXw.js";const Q={title:"Utils/ErrorFallback/ErrorFallbackWrapper",component:l,tags:["autodocs"],args:{},decorators:[r=>e(j,{sx:{bgcolor:"background.paper",p:2,border:1,borderColor:"grey.300",borderRadius:1},children:r()})]},a={args:{children:e(i,{})},render:r=>e(l,{...r})},o={args:{children:e(i,{message:"Unable to fetch user profile."})},render:r=>e(l,{...r}),parameters:{docs:{description:{story:"Pass `message` to ErrorFallbackText to override the default interpolation. Here it displays: “Unable to fetch user profile.”"}}}},s={args:{height:150,children:e(i,{name:"DashboardWidget"})},render:r=>e(l,{...r}),parameters:{docs:{description:{story:"Set `height` on ErrorFallbackWrapper to alter vertical centering. This example uses a 150px tall container."}}}},n={args:{height:200,sx:r=>({width:"100%",backgroundColor:r.palette.background.paper,border:1,borderColor:r.palette.error.main,borderRadius:2,p:1}),children:e(i,{name:"Chart"})},render:r=>{const M=R({palette:{background:{paper:"thistle"},error:{main:"#f44336"},grey:{100:"#f5f5f5"}}});return e(I,{theme:M,children:e(l,{...r})})},parameters:{docs:{description:{story:"- with custom theme"}}}},t={args:{children:null},render:()=>e(i,{message:"Inline load failure."}),parameters:{docs:{description:{story:"Use ErrorFallbackText alone when centering is handled externally (e.g., within a grid cell). Pass `message` or `name` as needed."}}}};var c,p,d,m,h;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
...
- Useful when centering or container is handled externally.`,...(H=(D=t.parameters)==null?void 0:D.docs)==null?void 0:H.description}}};const V=["Default","CustomMessage","CustomHeight","StyledWrapper","TextOnly"];export{s as CustomHeight,o as CustomMessage,a as Default,n as StyledWrapper,t as TextOnly,V as __namedExportsOrder,Q as default};
