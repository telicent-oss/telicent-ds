...
- \`size?: "small" | "medium"\` (default \`"small"\`)
        `}}}},n=[{label:"Afghanistan",value:"AF"},{label:"Albania",value:"AL"},{label:"Algeria",value:"DZ"},{label:"Andorra",value:"AD"},{label:"Angola",value:"AO"},{label:"Argentina",value:"AR"},{label:"Armenia",value:"AM"},{label:"Australia",value:"AU"},{label:"Austria",value:"AT"},{label:"Azerbaijan",value:"AZ"}],i={render:()=>{const[e,t]=l.useState(null);return r(o,{label:"Select country",value:e,onChange:t,options:n,placeholder:"Start typing…"})}},p={render:()=>{const[e,t]=l.useState(n.find(a=>a.value==="AT")??null);return r(o,{label:"Select country",value:e,onChange:t,options:n})}},u={render:()=>{const[e,t]=l.useState(null);return r(o,{label:"Country",value:e,onChange:t,options:n,helperText:"Pick your country of residence",placeholder:"Search countries"})}},m={render:()=>{const[e]=l.useState(n.find(t=>t.value==="AU")??null);return r(o,{label:"Country",value:e,onChange:()=>{},options:n,disabled:!0})}},c={render:()=>{const e=Array.from({length:50},(j,s)=>({label:`Option ${s+1}`,value:`opt-${s+1}`})),[t,a]=l.useState(null);return r(o,{label:"Lots of options",value:t,onChange:a,options:e,placeholder:"Type to filter…"})}},d={render:()=>{const e=Array.from({length:10},(j,s)=>({label:`Option ${s+1}`,value:`opt-${s+1}`})),[t,a]=l.useState([]);return r(o,{multiple:!0,label:"Countries",value:t,onChange:a,options:e})}};var v,h,g;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => {
...
}`,...(g=(h=i.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var b,y,A;p.parameters={...p.parameters,docs:{...(b=p.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => {
...
}`,...(A=(y=p.parameters)==null?void 0:y.docs)==null?void 0:A.source}}};var S,C,O;u.parameters={...u.parameters,docs:{...(S=u.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => {
    const [value, setValue] = useState<Option | null>(null);
...
}`,...(O=(C=u.parameters)==null?void 0:C.docs)==null?void 0:O.source}}};var f,V,x;m.parameters={...m.parameters,docs:{...(f=m.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => {
...
}`,...(x=(V=m.parameters)==null?void 0:V.docs)==null?void 0:x.source}}};var T,M,I;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => {
...
}`,...(I=(M=c.parameters)==null?void 0:M.docs)==null?void 0:I.source}}};var U,$,L;d.parameters={...d.parameters,docs:{...(U=d.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => {
    const many: Option[] = Array.from({
      length: 10
    }, (_, i) => ({
...
}`,...(L=($=d.parameters)==null?void 0:$.docs)==null?void 0:L.source}}};const st=["Basic","Preselected","WithHelperText","Disabled","LongList","MultiSelect"];export{i as Basic,m as Disabled,c as LongList,d as MultiSelect,p as Preselected,u as WithHelperText,st as __namedExportsOrder,at as default};
