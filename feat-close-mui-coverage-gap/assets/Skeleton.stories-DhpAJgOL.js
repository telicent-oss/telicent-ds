import{r as $,t as U,_ as A,c as i,j as M,M as j,I as p,L as x,a as B}from"./iframe-QjimQxGJ.js";import{g as X,c as E}from"./generateUtilityClass-DYVh7KgR.js";import{s as F}from"./styled-k9OHEYOT.js";import{g as N}from"./generateUtilityClasses-g9ufi11G.js";import{c as K}from"./composeClasses-fLhin0tj.js";import"./preload-helper-C1FmrZbK.js";import"./extendSxProp-CWL_eOV9.js";function L(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function O(t){return parseFloat(t)}function P(t){return X("MuiSkeleton",t)}N("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const W=["animation","className","component","height","style","variant","width"];let l=t=>t,m,g,f,b;const D=t=>{const{classes:e,variant:a,animation:s,hasChildren:o,width:d,height:n}=t;return K({root:["root",a,s,o&&"withChildren",o&&!d&&"fitContent",o&&!n&&"heightAuto"]},P,e)},I=x(m||(m=l`
  0% {
    opacity: 1;
  }
