import{j as e}from"./iframe-QjimQxGJ.js";import{u as r,M as d}from"./blocks-vWae7niR.js";import"./preload-helper-C1FmrZbK.js";import"./index-C895Ui_J.js";const l=[{pkg:"@mui/material",range:"^5.16.7",purpose:"MUI Material — core components."},{pkg:"@mui/lab",range:"5.0.0-alpha.170",purpose:"MUI Lab — experimental components used by DS internals."},{pkg:"@mui/x-date-pickers",range:"^8.9.2",purpose:"Backs the DS's DatePicker and DateTimePicker."},{pkg:"@emotion/react",range:"^11.10.6",purpose:"MUI's styling engine."},{pkg:"@emotion/styled",range:"^11.10.6",purpose:"Emotion's styled-components API, companion to @emotion/react."}];function t(s){const n={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Docs/Getting started/MUI dependencies"}),`
