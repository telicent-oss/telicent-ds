import{a as r}from"./iframe-QjimQxGJ.js";import{E as a}from"./ErrorFallbackText-D_comUev.js";import{B as w}from"./Box-BdgnJPj4.js";import"./preload-helper-C1FmrZbK.js";import"./Typography-BALYr_AM.js";import"./generateUtilityClass-DYVh7KgR.js";import"./styled-k9OHEYOT.js";import"./extendSxProp-CWL_eOV9.js";import"./generateUtilityClasses-g9ufi11G.js";import"./composeClasses-fLhin0tj.js";const H={title:"Utils/ErrorFallback/ErrorFallbackText",component:a,tags:["autodocs"],args:{name:"ExampleComponent",message:void 0},decorators:[e=>r(w,{sx:{bgcolor:"background.paper",p:2,border:1,borderColor:"grey.300",borderRadius:1,display:"flex",justifyContent:"center"},children:e()})]},s={args:{message:void 0,name:void 0},render:e=>r(a,{...e})},n={args:{message:"Custom failure message",name:void 0},render:e=>r(a,{...e})},o={args:{name:"DataWidget",message:void 0},render:e=>r(a,{...e})},t={args:{name:"name loses",message:"message wins"},render:e=>r(a,{...e})},d={args:{name:void 0,message:"http://long.uris.for.everyone/5da8fdf2-6f20-4050-a130-73a70caa524b/4ddf876b-d3ce-4012-94f7-e1aca0f1805b/fc2b2fb7-3c21-4e15-b7a8-766b5635c42a"},render:e=>r(a,{...e})};var m,i,c,g,p;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    message: undefined,
    name: undefined
  },
  ...
  render: (args: ErrorFallbackTextProps) => <ErrorFallbackText {...args} />
}`,...(P=(M=d.parameters)==null?void 0:M.docs)==null?void 0:P.source},description:{story:'WithNameAndMessage:\n- When `message` is undefined, uses `name` to generate:\n  "⚠️ {name} failed to load".',...(A=(S=d.parameters)==null?void 0:S.docs)==null?void 0:A.description}}};const I=["Defaults","DefaultText","WithName","WithNameAndMessage","Long"];export{n as DefaultText,s as Defaults,d as Long,o as WithName,t as WithNameAndMessage,I as __namedExportsOrder,H as default};
