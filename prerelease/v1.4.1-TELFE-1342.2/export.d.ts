...
import { default as default_6 } from '@mui/material/Stack';
...
declare type AriaKeys<T> = Extract<keyof T, `aria-${string}`>;
...
declare type BaseProps_2 = PropsWithChildren & {
    fullName: string;
};

declare interface BaseProps_3 {
    title?: string;
    content?: string;
}
...
declare type DataAriaRoleProps<T extends React_2.ElementType> = Pick<PropsOf<T>, DataKeys<PropsOf<T>> | AriaKeys<PropsOf<T>> | "role">;

declare type DataKeys<T> = Extract<keyof T, `data-${string}`>;
...
declare type PropsOf<T extends React_2.ElementType> = React_2.ComponentPropsWithoutRef<T>;
...
declare type TitleAndContentProps = WithDataAriaRole<typeof FlexBox, BaseProps_3>;
...
export declare const UserProfileContent: default_2.FC<UserProfileContentProps>;

declare type UserProfileContentProps = WithDataAriaRole<typeof default_6, PropsWithChildren>;

export declare type UserProfileProps = WithDataAriaRole<typeof default_6, BaseProps_2>;
...
declare type WithDataAriaRole<T extends React_2.ElementType, P = {}> = P & DataAriaRoleProps<T>;
